...
export default function Contact() {
    return <>
        ...
        <section className={`max-lg:mx-5 mx-30`}>
            <div className={`shadow-md bg-muted grid max-md:grid-cols-1 grid-cols-[2fr_3fr] gap-5 max-md:p-5 p-10 rounded-2xl w-full`}>
                <div className={``}>
                    <div className={`max-md:hidden backdrop-blur-2xl bg-white/10 border shadow-md border-white/20 rounded-2xl`}>
